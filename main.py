...
import traceback
from backend.interview.interview_manager import finish_interview,get_interview_state, process_answer,start_interview
from schemas.schemaV3 import AdaptiveAnswerRequest,AdaptiveInterviewStartRequest,AdaptiveInterviewState,AnswerProcessingResult,FinishAdaptiveInterviewRequest,InterviewStartResult
...
@app.post("/adaptive-interview/start",response_model=InterviewStartResult)
def start_adaptive_interview(request: AdaptiveInterviewStartRequest,) -> InterviewStartResult:
    ...
    try:
        return start_interview(
            ...
            maximum_questions_per_skill=(
                request.maximum_questions_per_skill
            ),
        )
...
@app.post("/adaptive-interview/answer",response_model=AnswerProcessingResult)
def submit_adaptive_answer(request: AdaptiveAnswerRequest) -> AnswerProcessingResult:
...
@app.get("/adaptive-interview/{interview_id}",response_model=AdaptiveInterviewState,)
def get_adaptive_interview(interview_id: str,) -> AdaptiveInterviewState:
...
@app.post("/adaptive-interview/finish",response_model=AdaptiveInterviewState,)
def finish_adaptive_interview(request: FinishAdaptiveInterviewRequest,) -> AdaptiveInterviewState:
